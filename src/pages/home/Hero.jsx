...
import { FaPlay, FaCheckCircle, FaReact, FaCodeBranch, FaJava, FaNodeJs, FaPython } from 'react-icons/fa';
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center overflow-hidden bg-[#0a0a0a] text-white pt-20 lg:pt-0 mt-10">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-[20%] left-[5%] opacity-10 animate-float-medium" style={{animationDelay: '2s'}}>
        ...
        <div className="absolute bottom-[10%] right-[30%] opacity-10 animate-float-slow" style={{animationDelay: '1s'}}>
        ...
        <div className="absolute top-[60%] right-[5%] opacity-5 text-6xl font-mono text-slate-500 animate-pulse-slow" style={{animationDelay: '1.5s'}}>
          {`{ }`}
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6 hover:bg-white/10 transition-colors cursor-default">
              ...
              <span className="text-xs font-mono text-purple-300">Start Your Journey</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link to="/register" className="w-full sm:w-auto px-8 py-4 bg-white text-black rounded-xl font-bold hover:bg-purple-50 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)]">
                Start For Free <RiRocketLine />
              </Link>
              <Link to="/courses" className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 text-white rounded-xl font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-2 backdrop-blur-sm">
            ...
            <div className="mt-8 flex items-center justify-center lg:justify-start gap-4 text-sm text-slate-500 font-mono">
              <span className="flex items-center gap-1"><FaCodeBranch /> v2.4.0</span>
              <span className="w-1 h-1 bg-slate-700 rounded-full"></span>
              <span className="flex items-center gap-1"><RiCpuLine /> Fast Load</span>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative h-[550px] flex items-center justify-center">
            ...
            <div className="relative z-20 w-full max-w-md bg-[#161b22]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden transform transition-all hover:scale-[1.02] duration-500 group">
              ...
              <div className="p-6 font-mono text-sm leading-7 text-slate-300">
                <div className="flex"><span className="text-pink-400 mr-2">class</span> <span className="text-yellow-200">FutureDev</span> {'{'}</div>
                <div className="pl-4">
                  <span className="text-purple-400">public static void</span> <span className="text-yellow-200">main</span>(String[] args) {'{'}
                </div>
                <div className="pl-8">
                  <span className="text-blue-300">System</span>.out.<span className="text-yellow-200">println</span>(<span className="text-green-300">"Hello Developer!"</span>);
                </div>
