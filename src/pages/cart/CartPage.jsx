    ...
    <div className="min-h-screen bg-transparent pt-32 pb-20 relative overflow-hidden text-slate-300">      
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        {cartItems && cartItems.length > 0 ? (
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-12">
            ...
            <div className="lg:w-2/3 space-y-6">
              {cartItems.map((item, index) => {
                ...
                return (
                  // Reusable glass-panel class with custom padding and hover states
                  <div key={uniqueId} className="glass-panel !p-5 flex flex-col sm:flex-row gap-6 items-center group hover:bg-white/10 hover:border-pink-500/30 transition-all hover:shadow-[0_8px_24px_rgba(244,114,182,0.15)]">
            ...
            <div className="lg:w-1/3 h-fit lg:sticky lg:top-32">
              <div className="glass-panel p-8 sm:p-10">
                ...
                {/* Checkout Button */}
                <Link to="/checkout" className="btn-primary w-full py-4 mb-6">
          ...
          /* --- Empty Cart State --- */
          <div className="glass-panel py-24 flex flex-col items-center justify-center max-w-3xl mx-auto text-center">
            ...
            <Link to="/courses" className="btn-primary py-3.5 px-10 w-fit">
